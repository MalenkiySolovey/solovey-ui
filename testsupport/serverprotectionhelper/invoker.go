// Package serverprotectionhelper supplies reusable Server Protection fixtures.
package serverprotectionhelper
...
type Invoker struct {
	...
	ManagedCandidateSemantic string
	ManagedTimedMembership   string
...
func NewNginx() *Invoker {
	capabilities := protectionhelper.DefaultCapabilities()
	identity := protectionhelper.BinaryIdentity{
		Path: "/usr/sbin/nginx", TargetPath: "/usr/sbin/nginx", Device: 1, Inode: 2,
...
func (i *Invoker) explicitResponse(request protectionhelper.Request, response protectionhelper.Response) protectionhelper.Response {
	...
	if response.OK && response.NFT != nil && request.Operation == protectionhelper.OperationNFTApply {
		if request.NFTApply.ExpectedPreviousTablePresent != i.ManagedTablePresent || request.NFTApply.ExpectedPreviousRevision != i.ManagedPlanRevision || request.NFTApply.ExpectedPreviousSemanticSHA256 != i.ManagedCandidateSemantic || request.NFTApply.ExpectedPreviousTimedMembershipSHA256 != i.ManagedTimedMembership {
		...
		i.managedRollbacks[request.NFTApply.RollbackArtifactPath] = managedFirewallState{present: i.ManagedTablePresent, revision: i.ManagedPlanRevision, sha256: i.ManagedCandidateSHA, semanticSHA: i.ManagedCandidateSemantic, timedMembershipSHA: i.ManagedTimedMembership, rollbackSHA: rollbackSHA}
		i.ManagedTablePresent, i.ManagedPlanRevision, i.ManagedCandidateSHA, i.ManagedCandidateSemantic, i.ManagedTimedMembership = true, request.NFTApply.ExpectedRevision, request.NFTApply.ExpectedSHA256, request.NFTApply.ExpectedSemanticSHA256, request.NFTApply.ExpectedTimedMembershipSHA256
	...
	if response.OK && response.NFT == nil {
		...
		case protectionhelper.OperationNFTObserve:
			response.NFT = &protectionhelper.NFTResult{ManagedTablePresent: i.ManagedTablePresent, CurrentRevision: i.ManagedPlanRevision, CurrentSemanticSHA256: i.ManagedCandidateSemantic, CurrentTimedMembershipSHA256: i.ManagedTimedMembership}
		case protectionhelper.OperationNFTValidate:
			response.NFT = &protectionhelper.NFTResult{CandidateSHA256: request.NFTValidate.ExpectedSHA256, SemanticSHA256: request.NFTValidate.ExpectedSemanticSHA256, TimedMembershipSHA256: request.NFTValidate.ExpectedTimedMembershipSHA256, PreviousTablePresent: i.ManagedTablePresent, PreviousRevision: i.ManagedPlanRevision, PreviousSemanticSHA256: i.ManagedCandidateSemantic, PreviousTimedMembershipSHA256: i.ManagedTimedMembership}
		case protectionhelper.OperationNFTApply:
			...
			if request.NFTApply.ExpectedPreviousTablePresent {
				rollbackSHA = i.ManagedCandidateSHA
			}
			i.managedRollbacks[request.NFTApply.RollbackArtifactPath] = managedFirewallState{present: i.ManagedTablePresent, revision: i.ManagedPlanRevision, sha256: i.ManagedCandidateSHA, semanticSHA: i.ManagedCandidateSemantic, timedMembershipSHA: i.ManagedTimedMembership, rollbackSHA: rollbackSHA}
			i.ManagedTablePresent, i.ManagedPlanRevision, i.ManagedCandidateSHA, i.ManagedCandidateSemantic, i.ManagedTimedMembership = true, request.NFTApply.ExpectedRevision, request.NFTApply.ExpectedSHA256, request.NFTApply.ExpectedSemanticSHA256, request.NFTApply.ExpectedTimedMembershipSHA256
			if err := i.FailAfter[request.Operation]; err != nil {
		...
		case protectionhelper.OperationNFTRollback:
			...
			if ok && request.NFTRollback.ExpectedCurrentRevision == i.ManagedPlanRevision && request.NFTRollback.ExpectedCurrentSemanticSHA256 == i.ManagedCandidateSemantic && request.NFTRollback.ExpectedCurrentTimedMembershipSHA256 == i.ManagedTimedMembership && (request.NFTRollback.ExpectedSHA256 == "" || request.NFTRollback.ExpectedSHA256 == previous.rollbackSHA) {
				i.ManagedTablePresent, i.ManagedPlanRevision, i.ManagedCandidateSHA, i.ManagedCandidateSemantic, i.ManagedTimedMembership = previous.present, previous.revision, previous.sha256, previous.semanticSHA, previous.timedMembershipSHA
			...
			if request.NFTRollback.ExpectedSHA256 == hex.EncodeToString(deleteSHA[:]) && request.NFTRollback.ExpectedCurrentRevision == i.ManagedPlanRevision {
				i.ManagedTablePresent, i.ManagedPlanRevision, i.ManagedCandidateSHA, i.ManagedCandidateSemantic, i.ManagedTimedMembership = false, "", "", "", ""
...
func facts() protectionhelper.InvocationFacts {
	return protectionhelper.InvocationFacts{ExitClass: "fixture"}
}
