...
type RemoteOutboundConnection struct {
	...
	MissingReason  string          `json:"missingReason" form:"missingReason" gorm:"column:missing_reason"`
	MissingSince   int64           `json:"missingSince" form:"missingSince" gorm:"column:missing_since;default:0;not null"`
