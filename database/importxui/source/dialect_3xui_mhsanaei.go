...
func (Dialect3XUIMHSanaei) ReadInbounds(db *sql.DB) ([]InboundRow, error) {
...
func (Dialect3XUIMHSanaei) ReadClients(db *sql.DB) ([]ClientTraffic, error) {
...
func (Dialect3XUIMHSanaei) ReadSettings(db *sql.DB) ([]Setting, error) {
...
func (Dialect3XUIMHSanaei) ReadUsers(db *sql.DB) ([]User, error) {
...
func (Dialect3XUIMHSanaei) ReadOutboundTraffics(db *sql.DB) ([]OutboundTraffic, error) {
