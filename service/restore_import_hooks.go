...
func init() {
	database.RegisterImportPostOpenHook("service.restore_post_open", runRestoreImportServicePostOpenActions)
}
...
func restoreImportServicePostOpenActions() []restoreImportPostOpenAction {
	return []restoreImportPostOpenAction{
		{
			name: "initializing restored settings",
			run:  initializeRestoreImportSettings,
		},
		{
			name: "resealing restored secret settings",
			run:  resealRestoreImportSecretSettings,
		},
		{
			name: "rotating restored sessions",
			run:  rotateRestoreImportSessions,
		},
	}
}
