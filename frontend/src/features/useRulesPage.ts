...
import { useRulesConfig } from '@/features/rules/useRulesConfig'
import { ruleActionsFor, ruleColumns, rulesetActionsFor, rulesetColumns } from '@/features/rules/tableConfig'
