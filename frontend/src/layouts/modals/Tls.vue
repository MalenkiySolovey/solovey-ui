      ...
      <v-card-text style="padding: 0 16px; overflow-y: scroll;">
        <v-card class="rounded-lg">
          ...
          <v-card-actions>
            ...
            <TlsOptionsMenu
              v-model:menu="menu"
              v-model:option-s-n-i="optionSNI"
              v-model:option-a-l-p-n="optionALPN"
              v-model:option-min-v="optionMinV"
              v-model:option-max-v="optionMaxV"
              v-model:option-c-s="optionCS"
              v-model:option-curve="optionCurve"
              v-model:option-client-auth="optionClientAuth"
              v-model:option-f-p="optionFP"
              v-model:option-store="optionStore"
              v-model:option-ktls="optionKtls"
              v-model:option-time="optionTime"
              :tls-type="tlsType"
            />
          </v-card-actions>
        </v-card>
