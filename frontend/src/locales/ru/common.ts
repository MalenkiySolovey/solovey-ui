export default {
  ...
  "stats": {
    ...
    "enable": "Включить статистику трафика"
  },
  "enable": "Включить",
  "disable": "Отключить",
  "none": "Никакие",
  ...
  "main": {
    ...
    "backup": {
      ...
      "restoreHint": "Восстанавливает резервную копию Solovey UI (.db). Для поддерживаемых баз сторонних панелей используйте импорт панелей.",
  ...
  "inboundDrafts": {
    "title": "Драфты входящих",
    "reviewHint": "Драфты — это только материал для проверки. Они не меняют живые входящие, пока вы явно не сохраните входящий.",
    "review": "Проверить"
  },
  "actions": {
    "action": "Действие",
