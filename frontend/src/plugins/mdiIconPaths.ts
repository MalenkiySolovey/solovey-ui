...
export const iconPaths: Record<string, string> = {
  ...
  'mdi-content-save-cog-outline': mdiContentSaveCogOutline,
  ...
  'mdi-lock-open-check-outline': mdiLockOpenCheckOutline,
  ...
  'mdi-monitor-lock': mdiMonitorLock,
