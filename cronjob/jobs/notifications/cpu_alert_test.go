...
func TestCPUAlertJobAlertsOnTransitions(t *testing.T) {
...
func TestCPUAlertJobDoesNotRepeatHighAlert(t *testing.T) {
	var events []string
	job := &CPUAlertJob{
...
func TestCPUAlertJobDisabledResetsState(t *testing.T) {
	enabled := true
	var events []string
	job := &CPUAlertJob{
		cpuPercent: func() float64 {
