...
type ClientConversionOptions = subconversion.ClientConversionOptions

func ConnectionOutboundConfig(connection RemoteOutboundConnection) (json.RawMessage, error) {
	return connectionOutboundConfig(connection, nil)
}
func connectionOutboundConfig(connection RemoteOutboundConnection, tagMap map[string]string) (json.RawMessage, error) {
...
func connectionOutboundMapForClient(connection RemoteOutboundConnection, tagMap map[string]string, options ClientConversionOptions) (map[string]interface{}, error) {
...
func applyClientConversion(connection RemoteOutboundConnection, outbound map[string]interface{}, options ClientConversionOptions) map[string]interface{} {
	if outbound == nil {
		return nil
	}
