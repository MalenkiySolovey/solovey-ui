...
func TestConnectionOutboundConfig(t *testing.T) {
	config, err := ConnectionOutboundConfig(RemoteOutboundConnection{
		Type:        "vless",
...
func TestOutboundsForClientLinksAddsMihomoSnapshotExtrasOnlyForMihomo(t *testing.T) {
	...
	if err := db.Create(&RemoteOutboundGroupConnection{GroupId: group.Id, ConnectionId: connection.Id}).Error; err != nil {
		t.Fatal(err)
	}
...
func TestOutboundsForClientLinksSupportsRemoteSubscriptionAll(t *testing.T) {
	...
	if err := db.Create(&RemoteOutboundGroupConnection{GroupId: group.Id, ConnectionId: connections[0].Id}).Error; err != nil {
		t.Fatal(err)
	}
...
func TestSyncConnectionToOutboundRewritesGroupRefs(t *testing.T) {
	db := newRemoteSyncDB(t)
	sub := RemoteOutboundSubscription{Name: "Remote"}
	if err := db.Create(&sub).Error; err != nil {
		t.Fatal(err)
	}
	node := RemoteOutboundConnection{
	...
	group := RemoteOutboundConnection{
		SubscriptionId: sub.Id,
		Name:           "auto",
	...
	var storedNode RemoteOutboundConnection
...
func TestReconcileOutboundLinksClearsMissingOutbound(t *testing.T) {
	...
	var stored RemoteOutboundConnection
...
func TestUniqueOutboundTagAvoidsExistingConnectionTag(t *testing.T) {
	...
	existing := RemoteOutboundConnection{
		SubscriptionId: sub.Id,
		Name:           "Node",
		SourceKey:      "node",
		OutboundTag:    "ros-Node",
