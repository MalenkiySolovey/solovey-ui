...
// SystemdApplicationOwnerInput binds the production runtime contract to the
// exact installed Systemd unit and release executable. The installer and
// signed update broker materialize this contract without external deployment
// state.
type SystemdApplicationOwnerInput struct {
	InstanceID          string
...
func SystemdApplicationOwner(input SystemdApplicationOwnerInput) (deploymentidentity.ApplicationOwnerContractV1, error) {
	...
	return deploymentidentity.NewSystemdV1(
