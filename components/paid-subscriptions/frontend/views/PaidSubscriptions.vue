<template>
  <page-header v-if="nexus" :title="$t('paidSub.title')" />
  <v-card flat>
...
import PaidSubscriptionManagementTabs from '../components/PaidSubscriptionManagementTabs.vue'
import PaidSubscriptionOrdersTabs from '../components/PaidSubscriptionOrdersTabs.vue'
import { usePaidSubscriptionsPage } from '../composables/pages/usePaidSubscriptionsPage'
