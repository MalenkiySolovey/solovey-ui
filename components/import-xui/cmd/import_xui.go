...
func init() {
	optionalcmd.Register(optionalcmd.Command{
		Name:      "import-xui",
		UsageLine: "    import-xui     import configuration from a supported panel database",
		Run: func(args []string, _ io.Reader, stdout io.Writer, _ io.Writer, _ func(string) string) int {
