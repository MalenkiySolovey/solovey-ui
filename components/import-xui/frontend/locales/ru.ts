export default {
  "migrateXui": {
    "backupAction": {
      ...
      "hint": "Быстрый импорт применяется сразу. Полный мастер даёт предпросмотр, разбор конфликтов и выбор того, что именно переносить. Сейчас поддерживается импорт баз 3x-ui/x-ui.",
