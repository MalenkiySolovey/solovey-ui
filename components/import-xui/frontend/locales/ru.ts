export default {
  "migrateXui": {
    "backupAction": {
      "title": "Импорт панелей",
      "hint": "Быстрый импорт применяется сразу. Полный мастер даёт предпросмотр, разбор конфликтов и выбор того, что именно переносить. Сейчас поддерживается импорт баз compatible panel.",
      "button": "Быстрый импорт — выбрать .db панели…",
    ...
    "title": "Миграция из compatible panel",
    "steps": {
      "upload": "Загрузка",
      "review": "Проверка",
      "progress": "Прогресс",
    ...
    "chooseFile": "База данных compatible panel",
    "strategy": "Стратегия конфликтов",
