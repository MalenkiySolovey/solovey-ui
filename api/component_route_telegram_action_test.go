...
func TestComponentRouteTelegramActionRequiresAdminScope(t *testing.T) {
	...
	recorder := performComponentTelegramActionRequest(router, readToken)
...
func TestComponentRouteTelegramActionAuditsWithoutSecrets(t *testing.T) {
	...
	recorder := performComponentTelegramActionRequest(router, adminToken)
...
func performComponentTelegramActionRequest(router *gin.Engine, token string) *httptest.ResponseRecorder {
