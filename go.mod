...
// cached by proxy.golang.org breaks Windows builds against newer sing-tun APIs.
// Pin the fixed release commit so all builders resolve the same immutable code.
