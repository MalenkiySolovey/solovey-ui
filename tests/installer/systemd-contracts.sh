...
install -d \
  ...
  "${fixture_root}/usr/local/solovey-ui" \
...
ln -s /usr/local/lib/solovey-ui/systemd/solovey-ui-native-hardened.service \
  "${fixture_root}/etc/systemd/system/solovey-ui.service"

install -m 0755 /bin/true "${fixture_root}/usr/local/solovey-ui/solovey-ui"
install -m 0755 /bin/true "${fixture_root}/usr/local/solovey-ui/solovey-privileged-broker"
...
systemd-analyze verify --root="${fixture_root}" --man=no --recursive-errors=no \
  ...
  /usr/local/lib/solovey-ui/systemd/solovey-ui-native-network-advanced.service \
  /usr/local/lib/solovey-ui/systemd/solovey-ui-native-legacy-root.service \
